...
export default function CardSolver({ list, resetKey, isRevealed, toggle, getAnswer, selectAnswer, resetAnswer, onAnswer, renderAbove }) {
  ...
  return (
    <div className="card-solver" ref={topRef}>
      ...
      <ProblemCard
        ...
        onSelect={(no, v) => { selectAnswer(p.chapterId, no, v); onAnswer?.(p, v) }}
